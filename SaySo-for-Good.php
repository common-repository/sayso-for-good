<?php
/*
Plugin Name: SaySo Pubs | Monetize & Engage Your Visitors
Plugin URI: https://wordpress.org/plugins/sayso-for-good/
...
class SaySoWidget extends WP_Widget {
...
class SaySoSurveys {
    ...
    function add_admin_bar_menu() {
        add_menu_page( "SaySo Surveys", "SaySo Surveys", "administrator", "SaySoSurveys", array($this, "admin_plugin_page"), "dashicons-desktop", 40);
    }
    ...
    function admin_plugin_page(){
        ...
        <?php
            ...
            if($_POST['oscimp_hidden'] == 'Y') {
                if(strlen(trim($_POST['activationString'])) == 57) {
                    //Form data sent
                    $codes = explode(":", trim($_POST['activationString']));
        ...
        <?php
            if($_POST['oscimp_hidden'] == 'Frame') {
                ...
                $frameHeight = trim($_POST['frameHeight']);
